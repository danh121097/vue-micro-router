...
/**
 * AdminPage — demonstrates:
 *   Phase 1: beforeEnter guard blocks unless authenticated (set in App.vue)
 *   Phase 1: transition:'none' — instant navigation, no animation
 *   Phase 1: Guard rejection behavior shown via UI toggle
 *   Core: auth state toggle for testing guard
 */
...
<template>
  <div class="page admin-page">
    ...
    <div class="info">
      <h3>Phase 1: Route Guard + Instant Transition</h3>
      <p>
        This page is protected by a global <code>beforeEach</code> guard in
        <code>App.vue</code>. Uncheck "Authenticated" then try navigating here
        from Home — the guard returns <code>false</code> and navigation cancels.
      </p>
